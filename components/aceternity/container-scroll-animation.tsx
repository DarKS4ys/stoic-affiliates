...
export const ContainerScroll = ({
  ...
  return (
    <div
      className="w-full md:w-[min(100%,85vw)] xl:w-[min(100%,60vw)] md:rounded-t-xl max-w-8xl z-20 m-0 aspect-video mx-auto flex items-center justify-center relative py-20 px-2 md:p-16"
      ref={containerRef}
    >
      <div
